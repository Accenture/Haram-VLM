...
try:
    ...
    from transformers import is_peft_available
    from transformers.utils import WEIGHTS_NAME, PREFIX_CHECKPOINT_DIR
    TRAINING_ARGS_NAME = "training_args.bin"
    TRAINER_STATE_NAME = "trainer_state.json"

try:
    from transformers.trainer import SAFE_WEIGHTS_NAME
except ImportError:
